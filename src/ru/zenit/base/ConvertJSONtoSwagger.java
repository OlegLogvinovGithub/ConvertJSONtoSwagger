...
//        cont.add(pnlButton);
        ...
        area2.setText("1) Выберите с помощью кнопки: \"Выбор JSON файла для обработки\" файл формата JSON для конвертации в формат Swagger\n "
        		   ...
        		   +  "3) Сохраните результат преобразования в файл, с помощью кнопки \"Сохранить результат\"\n"
          		   + "Результат можно скопировать кнопками ctrl-A ctrl-C \n\n"
